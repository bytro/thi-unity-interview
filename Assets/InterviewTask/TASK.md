...
We will review your solution together in the follow-up interview. We look at:

| Area | What we look for |
|---|---|
| **Correctness** | Does the outline appear on visible object edges? |
| **URP knowledge** | Is the feature/pass structure idiomatic for URP? |
| **Shader clarity** | Is the HLSL readable and well-structured? |
| **Trade-off awareness** | Can you explain your edge detection choice and its limitations? |
| **Self-awareness** | Do you know what you would improve with more time? |
